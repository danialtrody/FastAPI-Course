...
# print(f"{zombie.get_type_of_enemy()} has {zombie.health_points} health points "
#       f"and can do an attack of {zombie.attack_damage}")
#
#
# print(f"{ogre.get_type_of_enemy()} has {ogre.health_points} health points "
#       f"and can do an attack of {ogre.attack_damage}")
#
# zombie.talk()
# ogre.talk()